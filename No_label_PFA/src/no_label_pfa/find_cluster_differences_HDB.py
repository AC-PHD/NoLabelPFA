...
def find_cluster_differences_HDB(path_original_data, path_principal_features="principal_features0.txt", path_labels="hdbscan_labels.csv",  clusters=[], number_output_functions=1, frac=1):
